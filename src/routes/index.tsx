...
function Home() {
  ...
  return (
    ...
    <div className='flex flex-col border-t-2 border-gray-800/30 min-h-screen/2 mx-[12.5%] justify-center items-center py-5'>
      ...
      <p>Klikając przycisk «Sprawdź swoj document» wyrażam zgodę na przetwarzanie moich danych osobowych zgodnie z art. 6 ust. 1 lit. a Rozporządzenia Parlamentu Europejskiego i Rady (UE) 2016/679 z 27.04.2016 r. w sprawie ochrony osób fizycznych w związku z przetwarzaniem danych osobowych i w sprawie swobodnego przepływu takich danych oraz uchylenia dyrektywy 95/46/WE (ogólne rozporządzenie o ochronie danych).</p>
